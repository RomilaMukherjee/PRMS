...
public class PresenterScreenAdapter extends ArrayAdapter<User> {
    private static final String TAG = ProducerScreenAdapter.class.getName();

    public PresenterScreenAdapter(Context context, ArrayList<User> presenterList) {
        super(context, 0, presenterList);
    }
